export const experienceData = [
  {
    ...
    keyPoints: [
      ...
      `Facilitated monthly Women’s Advisory Board Journal Clubs`,
      `Supported a core Summit planning group for the first ever virtual 2021 Women’s Health and Activism Summit `
    ]
  },
  {
    ...
    keyPoints: [
      ...
      `Led and transcribed focus group meetings with high school students about the Michigan Model for Health Curriculum `
    ]
  }
];
